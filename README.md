...
Ferramentas de inteligência artificial foram usadas como apoio no
desenvolvimento deste trabalho, na escrita de código, na criação de testes e
na redação da documentação. Todo o conteúdo gerado foi revisado, executado e
validado por mim, e o comportamento do sistema é comprovado pelos 146 testes
automatizados do repositório. As decisões técnicas — modelagem da rede,
formulação das regras R1–R8, contratos da API e formato dos traces — e o
alinhamento ao enunciado do desafio são de minha responsabilidade.
